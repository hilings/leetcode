 ...
 */
    ...
    public class Solution
    {
        ...
        static void Main(string[] args)
        {
            ...
            int?[] nodes = new int?[] { 5, 3, 6, 2, 4, null, 8, 1, null, null, null, 7, 9 };
            TreeNode root = Deserialize(nodes);
            //sol.IncreasingBST2(root);
            TreeNode r = sol.IncreasingBST2(root);
            Serialize(r);   // [1,null,2,null,3,null,4,null,5,null,6,null,7,null,8,null,9]

            nodes = new int?[] { 5, 1, 7 };
            root = Deserialize(nodes);
            r = sol.IncreasingBST(root);
            Serialize(r);   // [1,null,5,null,7]
        }
    }
}
